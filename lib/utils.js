...
export const timeFormatter = (timestamp) => {
  ...
  formattedHours = formattedHours === "00" ? "12" : formattedHours; // Updated this line
...
export const dateFormatter = (date) => {
  ...
  return formatDate(newDate, "MMMM d");
};
...
export const filterDateFormatter = (schedule) => {
  ...
  const dateName = dateObject.toLocaleString("en-US", { weekday: "long" });
  return { month, day, dateName };
};
